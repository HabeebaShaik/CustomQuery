...
public class StudentService {
	...
	public Long countStudentsByAgeGreaterThan(Integer age) {
		return studentRepository.countStudentsByAgeGreaterThan(age);
	}
	
	 public Page<Student> findByDobGreaterThan(Date dob, int page, int size) {
	        Pageable pageable = PageRequest.of(page, size);
	        return studentRepository.findByDobGreaterThan(dob, pageable);
	    }
